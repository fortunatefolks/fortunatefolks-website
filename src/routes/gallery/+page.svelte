...
<section class="overflow-hidden text-neutral-700 mt-6">
	...
	<div class="container mx-auto px-5 py-2 lg:px-32 lg:pt-12">
		...
		<div class="w-[600px] px-40 text-center justify-center align-middle">
			<blockquote
				class="text-xl italic font-semibold text-gray-900 text-center justify-center align-middle"
			>
				<svg
					aria-hidden="true"
